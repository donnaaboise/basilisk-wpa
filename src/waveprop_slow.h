...
/* We need to intialize these in an event so that we know if we have a conservation
    law or not.  Might be better to have two separate .h files? */
